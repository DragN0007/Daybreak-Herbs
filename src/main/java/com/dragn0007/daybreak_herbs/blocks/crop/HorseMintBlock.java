...
public class HorseMintBlock extends HerbCropBlock {
   ...
   public HorseMintBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.HORSE_MINT.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.HORSE_MINT.get();
   }
