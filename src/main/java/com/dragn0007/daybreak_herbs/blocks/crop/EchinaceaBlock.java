...
public class EchinaceaBlock extends HerbCropBlock {
   ...
   public EchinaceaBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.ECHINACEA.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.ECHINACEA_ROOTS.get();
   }
