...
public class RattleweedBlock extends HerbCropBlock {
   ...
   public RattleweedBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.RATTLEWEED.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.RATTLEWEED.get();
   }
