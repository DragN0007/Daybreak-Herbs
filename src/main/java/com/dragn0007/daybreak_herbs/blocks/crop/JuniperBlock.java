...
public class JuniperBlock extends HerbCropBlock {
   ...
   public JuniperBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.JUNIPER.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.JUNIPER_BERRY.get();
   }
