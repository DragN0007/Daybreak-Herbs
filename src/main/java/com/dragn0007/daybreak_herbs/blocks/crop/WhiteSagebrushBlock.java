...
public class WhiteSagebrushBlock extends HerbCropBlock {
   ...
   public WhiteSagebrushBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.WHITE_SAGEBRUSH.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.WHITE_SAGEBRUSH.get();
   }
