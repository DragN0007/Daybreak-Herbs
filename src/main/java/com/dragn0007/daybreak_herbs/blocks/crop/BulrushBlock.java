...
public class BulrushBlock extends HerbCropBlock {
   ...
   public BulrushBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.BULRUSH.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.BULRUSH.get();
   }
