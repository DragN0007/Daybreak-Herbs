...
public class GoldenrodBlock extends HerbCropBlock {
   ...
   public GoldenrodBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.GOLDENROD.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.GOLDENROD.get();
   }
