...
public class ArnicaBlock extends HerbCropBlock {
   ...
   public ArnicaBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.ARNICA.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.ARNICA.get();
   }
