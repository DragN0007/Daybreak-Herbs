...
public class JewelweedBlock extends HerbCropBlock {
   ...
   public JewelweedBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.JEWELWEED.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.JEWELWEED.get();
   }
