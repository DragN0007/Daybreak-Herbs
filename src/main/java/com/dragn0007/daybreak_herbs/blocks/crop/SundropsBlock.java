...
public class SundropsBlock extends HerbCropBlock {
   ...
   public SundropsBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.SUNDROPS.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.SUNDROPS.get();
   }
