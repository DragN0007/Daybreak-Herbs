...
public class SweetrootBlock extends HerbCropBlock {
   ...
   public SweetrootBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.SWEETROOT.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.SWEETROOT.get();
   }
