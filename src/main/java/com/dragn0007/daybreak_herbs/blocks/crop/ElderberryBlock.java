...
public class ElderberryBlock extends HerbCropBlock {
   ...
   public ElderberryBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.ELDERBERRY.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.ELDERBERRY.get();
   }
