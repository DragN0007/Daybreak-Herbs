...
public class GoldensealBlock extends HerbCropBlock {
   ...
   public GoldensealBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.GOLDENSEAL.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.GOLDENSEAL.get();
   }
