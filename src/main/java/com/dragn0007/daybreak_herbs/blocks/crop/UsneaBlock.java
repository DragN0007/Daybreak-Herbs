...
public class UsneaBlock extends HerbCropBlock {
   ...
   public UsneaBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.USNEA.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.USNEA.get();
   }
