...
public class BonesetBlock extends HerbCropBlock {
   ...
   public BonesetBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.BONESET.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.BONESET.get();
   }
