...
public class MarshMallowBlock extends HerbCropBlock {
   ...
   public MarshMallowBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.MARSH_MALLOW.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.MARSH_MALLOW.get();
   }
