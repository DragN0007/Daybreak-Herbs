...
public class WinterbloomBlock extends HerbCropBlock {
   ...
   public WinterbloomBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.WINTERBLOOM.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.WINTERBLOOM.get();
   }
