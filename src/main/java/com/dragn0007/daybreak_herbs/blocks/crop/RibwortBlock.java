...
public class RibwortBlock extends HerbCropBlock {
   ...
   public RibwortBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.RIBWORT.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.RIBWORT.get();
   }
