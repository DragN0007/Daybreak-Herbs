...
public class YarrowBlock extends HerbCropBlock {
   ...
   public YarrowBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.YARROW.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.YARROW.get();
   }
