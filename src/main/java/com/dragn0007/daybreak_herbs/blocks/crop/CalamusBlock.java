...
public class CalamusBlock extends HerbCropBlock {
   ...
   public CalamusBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return DBHBlocks.CALAMUS.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return DBHItems.CALAMUS.get();
   }
