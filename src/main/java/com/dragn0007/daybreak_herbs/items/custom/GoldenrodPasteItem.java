...
public class GoldenrodPasteItem extends HerbalItem {

    public GoldenrodPasteItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.daybreak_herbs.goldenrod_paste.tooltip").withStyle(ChatFormatting.GRAY));
