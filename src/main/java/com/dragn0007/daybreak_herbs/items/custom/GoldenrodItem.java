...
public class GoldenrodItem extends HerbalNameBlockItem {
    ...
    public GoldenrodItem(Block block, Item.Properties properties) {
    ...
    public ItemStack finishUsingItem(ItemStack itemStack, Level level, LivingEntity entity) {
        ItemStack processedStack = new ItemStack(DBHItems.GOLDENROD_PETALS.get());
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.daybreak_herbs.goldenrod.tooltip").withStyle(ChatFormatting.GRAY));
        pTooltipComponents.add(Component.translatable("tooltip.daybreak_herbs.petals.tooltip").withStyle(ChatFormatting.GREEN));
        pTooltipComponents.add(Component.translatable("tooltip.daybreak_herbs.goldenrod_plants.tooltip").withStyle(ChatFormatting.YELLOW));
    }
}
