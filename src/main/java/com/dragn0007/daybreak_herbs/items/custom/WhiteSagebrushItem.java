...
public class WhiteSagebrushItem extends HerbalNameBlockItem {

    public WhiteSagebrushItem(Block block, Properties properties) {
    ...
    public ItemStack finishUsingItem(ItemStack itemStack, Level level, LivingEntity entity) {
        ItemStack processedStack = new ItemStack(DBHItems.WHITE_SAGEBRUSH_LEAF.get());
