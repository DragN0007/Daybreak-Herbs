...
public class HorseMintItem extends HerbalNameBlockItem {

    public HorseMintItem(Block block, Properties properties) {
    ...
    public ItemStack finishUsingItem(ItemStack itemStack, Level level, LivingEntity entity) {
        ItemStack processedStack = new ItemStack(DBHItems.HORSE_MINT_PETALS.get());
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.daybreak_herbs.horse_mint.tooltip").withStyle(ChatFormatting.GRAY));
        ...
        pTooltipComponents.add(Component.translatable("tooltip.daybreak_herbs.horse_mint_plants.tooltip").withStyle(ChatFormatting.YELLOW));
    }
}
