...
public class HorseMintItem extends HerbalNameBlockItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.horse_mint.tooltip").withStyle(ChatFormatting.GRAY));
        ...
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.horse_mint_plants.tooltip").withStyle(ChatFormatting.GRAY));
    }
}
